              ...
              >
                {showPassword ? (
                  ...
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <path d="M15.171 13.576l1.414 1.414A10.015 10.015 0 0020.485 10C19.211 5.943 15.421 3 10.943 3a9.958 9.958 0 00-1.414.12l2.06 2.06c.51-.045 1.023-.07 1.541-.07a10 10 0 019.497 6.063a9.968 9.968 0 01-1.504 2.523z" />
                  </svg>
                )}
              </button>
            </div>
